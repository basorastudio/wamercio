...
const defaultLandingPage = (domain = 'ltd.do') => ({
  ...
  modules: [
    ...
    { icon: 'shoppingbag', title: 'Funda de compra', text: 'Experiencia intuitiva para armar pedidos y enviarlos por WhatsApp.' },
  ...
  rd_tags: ['RD$', 'Cédula', 'Funda', 'Fiado', 'Entrega por barrio', 'Provincias y municipios', 'Sectores y zonas de entrega', 'WhatsApp', 'Efectivo y transferencia', 'Negocios de barrio', 'PWA'],
  ...
  business_types: ['Colmados', 'Super colmados', 'Minimarkets', 'Provisiones', 'Surtidoras', 'Bodegas', 'Pulperías', 'Negocios con entrega local', 'Negocios con ventas fiadas', 'Comercios con cajeros', 'Comercios con repartidores', 'Propietarios con varios negocios'],
  ...
  roles: [
    ...
    { icon: 'smartphone', title: 'Cliente', text: 'Consulta productos, arma su funda, hace pedidos, revisa sus compras y puede ver su fiado.' },
  ...
  steps: [
    ...
    { title: 'Recibe pedidos', text: 'Los clientes agregan productos a la funda y envían pedidos organizados.' },
...
const LogoMark = ({ landing, dark = false }: any) => {
  const logo = landing.logo_url || landing.logoUrl || '/brand/colmapro-app-icon.png';
  if (logo) {
    return (
