...
const defaultLandingPage = (domain = 'ltd.do') => ({
  ...
  rd_tags: ['RD$', 'Cédula', 'Funda', 'Fiado', 'Entrega por barrio', 'Provincias y municipios', 'Sectores y zonas de entrega', 'WhatsApp', 'Efectivo y transferencia', 'Comercio local', 'PWA'],
  ...
  business_types: ['Tiendas', 'Supermercados', 'Minimarkets', 'Provisiones', 'Surtidoras', 'Bodegas', 'Pulperías', 'Negocios con entrega local', 'Negocios con ventas fiadas', 'Comercios con cajeros', 'Comercios con repartidores', 'Propietarios con varios negocios'],
