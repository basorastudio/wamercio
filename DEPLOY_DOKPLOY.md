# Despliegue WAMERCIO 2.8.11 en Dokploy

1. Conserva los volúmenes de PostgreSQL, Redis y uploads.
2. Sustituye el código por **WAMERCIO 2.8.11**.
3. Ejecuta `sh scripts/verify-2.8.11.sh` antes del despliegue.
4. No hay migraciones nuevas en 2.8.11; la última continúa siendo `000036_customer_address_geolocation`.
