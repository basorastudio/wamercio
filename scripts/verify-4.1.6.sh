...
[ "$(cat VERSION)" = "4.1.6" ] || fail VERSION
grep -q '"version": "4.1.6"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v4.1.6' apps/web/public/sw.js || fail 'PWA cache'
...
PY3
echo 'gofmt: OK'; echo 'Shell syntax: OK'; echo 'PASS: WAMERCIO 4.1.6 release verification'
