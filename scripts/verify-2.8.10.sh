...
grep -q 'pointer-events-none' apps/web/components/customer-location-map.tsx || fail 'non-interactive preview'
grep -q 'www.google.com/maps/search/?api=1&query=' apps/web/components/customer-location-map.tsx || fail 'external Google Maps link'
