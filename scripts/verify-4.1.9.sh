...
[ "$(cat VERSION)" = "4.1.9" ] || fail VERSION
grep -q '"version": "4.1.9"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v4.1.9' apps/web/public/sw.js || fail 'PWA cache'
python3 scripts/test_4_1_9_direct_pip.py
...
PY3
echo 'gofmt: OK'; echo 'Shell syntax: OK'; echo 'PASS: WAMERCIO 4.1.9 release verification'
