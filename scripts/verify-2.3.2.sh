...
[ "$(cat VERSION)" = "2.3.2" ] || fail 'VERSION'
grep -q '"version": "2.3.2"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v2.3.2' apps/web/public/sw.js || fail 'PWA cache'
...
echo 'PASS: WAMERCIO 2.3.2 static verification'
