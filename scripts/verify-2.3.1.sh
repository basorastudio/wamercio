...
[ "$(cat VERSION)" = "2.3.1" ] || fail 'VERSION'
grep -q '"version": "2.3.1"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v2.3.1' apps/web/public/sw.js || fail 'PWA cache'
...
[ -f services/api/migrations/000016_owner_profile_tabs.up.sql ] || fail 'migration 000016 up'
[ -f services/api/migrations/000016_owner_profile_tabs.down.sql ] || fail 'migration 000016 down'
...
echo 'PASS: WAMERCIO 2.3.1 static verification'
