...
need(Path('VERSION'),'2.5.4','version 2.5.4')
...
need(Path('services/domain-router/cmd/router/render.go'),'certResolver: letsencrypt','exact host TLS resolver')
forbid(Path('infra/traefik/wamercio.yml'),'HostRegexp','base wildcard tenant router removed')
...
if errors:
    print('FAIL: WAMERCIO 2.5.4 multitenant host regression')
    for e in errors: print(' -',e)
    sys.exit(1)
print('PASS: WAMERCIO 2.5.4 multitenant host regression')
