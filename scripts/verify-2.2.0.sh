...
[ "$(cat VERSION)" = "2.2.0" ] || fail 'VERSION'
grep -q '"version": "2.2.0"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v2.2.0' apps/web/public/sw.js || fail 'PWA cache'
...
echo 'PASS: WAMERCIO 2.2.0 static verification'
