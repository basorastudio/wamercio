...
[ "$(cat VERSION)" = "2.5.0" ] || fail 'VERSION'
grep -q '"version": "2.5.0"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v2.5.0' apps/web/public/sw.js || fail 'PWA cache'

python3 scripts/test_2_5_0_multitenant_hosts.py
...
echo 'PASS: WAMERCIO 2.5.0 static verification'
