...
shortcut = (root/'apps/web/app/[storeSlug]/page.tsx').read_text()
...
checks = [
    ...
    ('short public path only redirects from the platform host', "from 'next/headers'" in shortcut and 'isPlatform' in shortcut and 'notFound()' in shortcut),
]
