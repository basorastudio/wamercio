...
assert text('VERSION').strip()=='4.1.3'
assert '"version": "4.1.3"' in text('apps/web/package.json')
assert 'wamercio-store-v4.1.3' in text('apps/web/public/sw.js')
...
print('PASS: WAMERCIO 4.1.3 integrated calls contract')
...
print('PASS: WAMERCIO 4.1.3 softphone UX contract')
