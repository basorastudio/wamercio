...
assert text('VERSION').strip()=='4.1.1'
assert '"version": "4.1.1"' in text('apps/web/package.json')
assert 'wamercio-store-v4.1.1' in text('apps/web/public/sw.js')
...
print('PASS: WAMERCIO 4.1.1 integrated calls contract')


# 4.1.1 global softphone UX derived from the Hierro del Norte pattern.
...
print('PASS: WAMERCIO 4.1.1 softphone UX contract')
