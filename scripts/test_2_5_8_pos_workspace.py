...
checks = [
    ...
    ('POS catalog toolbar remains sticky', 'data-testid="pos-catalog-toolbar"' in pos and 'sticky top-[82px]' in pos),
    ('POS sale panel fills desktop viewport', 'data-testid="pos-sale-panel"' in pos and 'h-[calc(100dvh-98px)]' in pos),
