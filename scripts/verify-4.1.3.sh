...
[ "$(cat VERSION)" = "4.1.3" ] || fail VERSION
grep -q '"version": "4.1.3"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v4.1.3' apps/web/public/sw.js || fail 'PWA cache'
python3 scripts/test_4_1_3_build_scope.py
python3 scripts/test_4_1_3_softphone_ui.py
...
PY3
echo 'gofmt: OK'; echo 'Shell syntax: OK'; echo 'PASS: WAMERCIO 4.1.3 release verification'
