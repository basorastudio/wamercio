...
[ "$(cat VERSION)" = "4.1.8" ] || fail VERSION
grep -q '"version": "4.1.8"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v4.1.8' apps/web/public/sw.js || fail 'PWA cache'
python3 scripts/test_4_1_8_single_pip_identity.py
...
go run scripts/check_go_scope.go services/api/internal/httpapi services/whatsapp-bridge/internal/bridge services/whatsapp-bridge/internal/voip/call services/whatsapp-bridge/internal/voip/transport services/whatsapp-bridge/internal/wacall
python3 - <<'PY2'
...
PY3
echo 'gofmt: OK'; echo 'Shell syntax: OK'; echo 'PASS: WAMERCIO 4.1.8 release verification'
