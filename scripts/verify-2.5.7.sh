...
[ "$(cat VERSION)" = "2.5.7" ] || fail 'VERSION'
grep -q '"version": "2.5.7"' apps/web/package.json || fail 'web version'
grep -q 'wamercio-store-v2.5.7' apps/web/public/sw.js || fail 'PWA cache'
...
echo 'PASS: WAMERCIO 2.5.7 static verification'
