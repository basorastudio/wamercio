...
export type Customer={id:string;store_id:string;name:string;phone:string;address:string;notes:string;status:'active'|'blocked';blocked_reason?:string;blocked_at?:string|null;cheque_enabled?:boolean;order_count:number;total_spent:number;last_order_at?:string|null;created_at:string;contact_type?:'customer';whatsapp_name?:string;profile_picture_url?:string}
