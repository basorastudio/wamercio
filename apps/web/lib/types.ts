...
export type Store={
  ...
  bank_account_type?:string;business_hours?:Record<string,BusinessHoursDay>;order_notice?:string;checkout_message?:string;accepting_orders?:boolean;open_now?:boolean
}
