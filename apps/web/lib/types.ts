...
export type Customer={id:string;store_id:string;name:string;phone:string;address:string;notes:string;status:'active'|'blocked';order_count:number;total_spent:number;last_order_at?:string|null;created_at:string}
