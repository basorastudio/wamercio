...
import {LayoutDashboard,UsersRound,BadgeDollarSign,LogOut,Menu,X,UserRound,ShieldCheck,MonitorCog,Settings,ContactRound,Globe2} from 'lucide-react'

const nav=[
 {href:'/admin',label:'Resumen',icon:LayoutDashboard,key:'dashboard'},
