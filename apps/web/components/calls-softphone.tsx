  ...
  const activeControls=()=>{
    ...
    return <>
      <div className="wam-contact">
        {currentCall?.metadata?.avatar_url?<img className="avatar" src={currentCall.metadata.avatar_url} alt=""/>:<div className="avatar">{(currentCall.display_name||currentCall.phone||'?').slice(0,2).toUpperCase()}</div>}
