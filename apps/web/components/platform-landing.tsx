...
export default function Landing(){
  ...
  const features=[
    ...
    {icon:featureIcons[2],title:text(landing.feature_3_title,'Métodos de pago simples'),text:text(landing.feature_3_text,'Efectivo, transferencia electrónica o tarjeta en terminal, sin obligarte a contratar una pasarela.')},
