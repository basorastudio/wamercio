...
export default function Customers(){
 ...
 return <AdminShell title="Clientes" subtitle="CRM comercial creado automáticamente desde pedidos y WhatsApp">
  <div className="mb-5 grid gap-3 sm:grid-cols-[240px_1fr]"><StoreSelector value={store} onChange={setStore}/><SearchBox value={search} onChange={setSearch} placeholder="Buscar por nombre o WhatsApp..."/></div>
