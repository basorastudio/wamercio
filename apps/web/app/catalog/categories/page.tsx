...
export default function Categories(){
 ...
 return <StoreShell title="Categorías" subtitle="Organiza tu catálogo de forma simple" actions={<button disabled={!store} onClick={()=>start()} className="btn-primary"><Plus className="h-4 w-4"/> Nueva categoría</button>}>
